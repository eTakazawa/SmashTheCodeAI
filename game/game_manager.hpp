...
public:
  ...
  /**
   * communicateToAITurnを全てのプレイヤーに対し行う
   */
  template<class T1, class T2>
  ...
  /**
   * pipeと通信し，1ターン分状態を更新する．(@note 要:toNextTurn)
   */
  template<class T1, class T2>
  ...
  /**
   * 次のターンへ進む
   * turn_, nexts_colors_, curr_scores_を更新
   */
  void toNextTurn() {
    turn_++;
